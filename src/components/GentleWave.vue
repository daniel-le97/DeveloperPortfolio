<template>
  ...
  >
    ...
    <g class="parallax1">
      <use xlink:href="#gentle-wave" x="50" y="3" fill="#dcddbf" />
    </g>
    <g class="parallax2">
      <use xlink:href="#gentle-wave" x="50" y="0" fill="#41686f" />
    </g>
    <g class="parallax3">
...
.parallax4 > use {
  animation: move-forever4 20s linear infinite;
  &:nth-child(1) {
    animation-delay: -2s;
  }
}
