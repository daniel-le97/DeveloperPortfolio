      ...
      <div class="row my-5">
        ...
        <div class="col-md-5 position-relative">
          ...
          >
            ...
            >
             Custom Designed and built Website for a small yoga business owner, intergrated Ghost for CMS Publishing for her blog as well as configuring MailGun for Email Service.
             Allows her 
            </div>
      ...
      <div class="row my-6" style="">
        <div class="col-md-5 position-relative text-end">
          ...
          >
            ...
            >
            Wanting to test my knowledge coming out of CodeWorks I with my brothers who also attended the course  designed and architected a BookBub clone site to browse, search and favorite books. where we integrated and utilzied Google's Book API and transfering data over to our MySQL Database.
            </div>
          ...
          >
            <div class="d-flex justify-content-between">
             ...
             <div class="d-flex align-items-center">
               <GitHubIcon v-motion-slide-visible-bottom :delay="100" />
              <a
              
              v-motion-slide-visible-bottom :delay="600"
              href="" class="ms-3">
                <img src="https://cdn-icons-png.flaticon.com/512/5873/5873833.png" alt="External Link to Webpage" width="30" height="30">
              </a>
             </div>
            </div>
